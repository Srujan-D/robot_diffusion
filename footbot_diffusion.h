...
public:
	...
	/*
	 * This function calculates the direction of motion for the robot.
	 * It uses the readings of the proximity sensor to make the decision.
	*/
	virtual int obstacle_decide_motion_direction(const CCI_FootBotProximitySensor::TReadings& tProxReads);
